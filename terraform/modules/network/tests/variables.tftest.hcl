...
run "assert_peering_network_address_4" {
  command = plan
  variables {
    peering_network_address = "10.0.102.0/24" # error
    subnet_ip = "10.3.101.0/24"
  }
  expect_failures = [
    var.peering_network_address,
...
run "assert_peering_network_address_5" {
  command = plan
  variables {
    peering_network_address = "10.5.102.0/24" # error
    subnet_ip = "10.3.101.0/24"
  }
  expect_failures = [
    var.peering_network_address,
...
run "assert_peering_network_address_6" {
  command = plan
  variables {
    peering_network_address = "10.3.0.0/24" # error
    subnet_ip = "10.3.101.0/24"
  }
  expect_failures = [
    var.peering_network_address,
...
run "assert_peering_network_address_7" {
  command = plan
  variables {
    peering_network_address = "10.3.255.0/24" # error
    subnet_ip = "10.3.101.0/24"
  }
  expect_failures = [
    var.peering_network_address,

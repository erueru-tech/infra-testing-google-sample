...
output "peering_peering_routes_name" {
  value = google_compute_network_peering_routes_config.peering_peering_routes.peering
}

output "peering_peering_routes_vpc_name" {
  value = google_compute_network_peering_routes_config.peering_peering_routes.network
}

output "peering_peering_routes_import_custom_routes" {
  value = google_compute_network_peering_routes_config.peering_peering_routes.import_custom_routes
}

output "peering_peering_routes_export_custom_routes" {
  value = google_compute_network_peering_routes_config.peering_peering_routes.export_custom_routes
}
